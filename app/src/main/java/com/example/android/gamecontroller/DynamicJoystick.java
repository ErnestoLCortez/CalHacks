...
public class DynamicJoystick extends View implements Runnable {
    // Constants
    ...
    public DynamicJoystick(Context context) {
        super(context);
    }

    public DynamicJoystick(Context context, AttributeSet attrs) {
        super(context, attrs);
        initJoystickView();
    }

    public DynamicJoystick(Context context, AttributeSet attrs, int defaultStyle) {
